...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-12-2021 a las 17:47:15
...
--
-- Base de datos: `baseautopartesguero`
--
...
(2, 1, 'Tomas', 2147483647, 'Chilapa, San José', 1);
...
(1, 2580, 'Autopartes Guero', 'Autopartes Guero', 925491523, 'Autopartesguero@gmail.com', 'Boulevard', '1.18');
...
(1, '2021-11-30 15:09:07', 1, 2, '2500.00', 1);
...
(1, 'Oswal', 'olivermeza111@gmail.com', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1),
(6, 'Oswal', 'maria@gmail.com', 'Oswal', '263bce650e68ab4e23f28263760b9fa5', 3);
...
--
ALTER TABLE `detallefactura`
  MODIFY `correlativo` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
